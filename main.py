...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendancerealtime-748d0.appspot.com"
})
...
imgBackground = cv2.imread("C:\\Users\\Divyansh Bose\\PycharmProjects\\FaceRecognitionRealTimeDatabase\\Resources\\background.png")

# Importing the mode images into a list
folderModePath = "C:\\Users\\Divyansh Bose\\PycharmProjects\\FaceRecognitionRealTimeDatabase\\Resources\\Modes"
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                blob = bucket.get_blob(f'C:\\Users\\Divyansh Bose\\PycharmProjects\\FaceRecognitionRealTimeDatabase\\Images/{id}.png')
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    offset = (414 - w) // 2
                    cv2.putText(imgBackground, str(studentInfo['major']), (950 + offset, 550), cv2.FONT_HERSHEY_COMPLEX, 0.5,
                                (255, 255, 255), 1)
